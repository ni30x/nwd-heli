...
import helium314.keyboard.settings.screens.TypingHistorySettingsScreen
import helium314.keyboard.settings.screens.TypingHistoryViewerScreen
import helium314.keyboard.settings.screens.TypingHistoryManageScreen
import helium314.keyboard.settings.screens.TypingHistoryExcludedAppsScreen
    ...
    NavHost(
        ...
        composable(SettingsDestination.Settings) {
            MainSettingsScreen(
                ...
                onClickTypingHistory = { navController.navigate(SettingsDestination.TypingHistory) },
                onClickBack = ::goBack,
            )
        }
        ...
        composable(SettingsDestination.TypingHistory) {
            TypingHistoryViewerScreen(
                onClickBack = ::goBack,
                onClickExcludedApps = { navController.navigate(SettingsDestination.TypingHistoryExcludedApps) }
            )
        }
        composable(SettingsDestination.TypingHistoryExcludedApps) {
            TypingHistoryExcludedAppsScreen(onClickBack = ::goBack)
        }
...
object SettingsDestination {
    ...
    const val TypingHistory = "typing_history"
    const val TypingHistoryViewer = "typing_history_viewer"
    const val TypingHistoryManage = "typing_history_manage"
    const val TypingHistoryExcludedApps = "typing_history_excluded_apps"
