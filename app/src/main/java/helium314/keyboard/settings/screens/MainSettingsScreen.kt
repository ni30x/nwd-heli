    ...
    SearchSettingsScreen(
        ...
        Scaffold(contentWindowInsets = WindowInsets.safeDrawing.only(WindowInsetsSides.Bottom)) { innerPadding ->
            Column(
                ...
                Preference(
                    name = stringResource(R.string.settings_screen_typing_history),
                    onClick = onClickTypingHistory,
                    icon = R.drawable.ic_settings_typing_history
                ) { NextScreenIcon() }
                Preference(
