...
public final class Settings implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public static final String PREF_TYPING_HISTORY_PASSWORD_HASH = "typing_history_password_hash";
    public static final String PREF_TYPING_HISTORY_SALT = "typing_history_salt";
    ...
    public static final String PREF_TYPING_HISTORY_RETENTION_DAYS = "typing_history_retention_days";
    ...
    private static boolean reloadOnChanged(String key) {
        return switch (key) {
            case PREF_LAST_SHOWN_EMOJI_CATEGORY_PAGE_ID, PREF_LAST_SHOWN_EMOJI_CATEGORY_ID, PREF_RECENT_EMOJIS,
                 PREF_DONT_SHOW_MISSING_DICTIONARY_DIALOG, PREF_SELECTED_SUBTYPE,
                 PREF_TYPING_HISTORY_ENABLED, PREF_TYPING_HISTORY_PASSWORD_HASH, PREF_TYPING_HISTORY_SALT,
                 PREF_TYPING_HISTORY_RECORD_PASSWORDS, PREF_TYPING_HISTORY_MASK_PASSWORDS,
                 PREF_TYPING_HISTORY_EXCLUDE_APPS, PREF_TYPING_HISTORY_RETENTION_DAYS -> false;
    ...
    // Typing History helper methods
    public static boolean readTypingHistoryEnabled(SharedPreferences prefs) {
        return prefs.getBoolean(PREF_TYPING_HISTORY_ENABLED, Defaults.PREF_TYPING_HISTORY_ENABLED);
    }

    public static boolean readTypingHistoryRecordPasswords(SharedPreferences prefs) {
        return prefs.getBoolean(PREF_TYPING_HISTORY_RECORD_PASSWORDS, Defaults.PREF_TYPING_HISTORY_RECORD_PASSWORDS);
    }

    public static boolean readTypingHistoryMaskPasswords(SharedPreferences prefs) {
        return prefs.getBoolean(PREF_TYPING_HISTORY_MASK_PASSWORDS, Defaults.PREF_TYPING_HISTORY_MASK_PASSWORDS);
    }

    public static String readTypingHistoryExcludeApps(SharedPreferences prefs) {
        return prefs.getString(PREF_TYPING_HISTORY_EXCLUDE_APPS, Defaults.PREF_TYPING_HISTORY_EXCLUDE_APPS);
    }

    public static void writeTypingHistoryExcludeApps(SharedPreferences prefs, String commaSeparatedPackages) {
        prefs.edit().putString(PREF_TYPING_HISTORY_EXCLUDE_APPS, commaSeparatedPackages).apply();
    }

    public static int readTypingHistoryRetentionDays(SharedPreferences prefs) {
        return prefs.getInt(PREF_TYPING_HISTORY_RETENTION_DAYS, Defaults.PREF_TYPING_HISTORY_RETENTION_DAYS);
    }

    public static String readTypingHistoryPasswordHash(SharedPreferences prefs) {
        return prefs.getString(PREF_TYPING_HISTORY_PASSWORD_HASH, Defaults.PREF_TYPING_HISTORY_PASSWORD_HASH);
    }
