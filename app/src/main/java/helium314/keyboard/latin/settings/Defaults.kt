...
object Defaults {
    ...
    const val PREF_TYPING_HISTORY_MASK_PASSWORDS = true
    const val PREF_TYPING_HISTORY_EXCLUDE_APPS = ""
    const val PREF_TYPING_HISTORY_RETENTION_DAYS = -1 // -1 = keep forever (manual delete only)
}
